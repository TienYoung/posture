...
#ifndef STM32F3DISCOVERY_BUS_H
#define STM32F3DISCOVERY_BUS_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f3discovery_conf.h"
...
/** @defgroup STM32F3DISCOVERY_BUS_Exported_Constants STM32F3DISCOVERY BUS Exported Constants
  * @{
  */
...
/** @defgroup STM32F3DISCOVERY_BUS_Private_Types STM32F3DISCOVERY BUS Private types
  * @{
  */
...
/** @defgroup STM32F3DISCOVERY_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup STM32F3DISCOVERY_BUS_Exported_Functions
  * @{
  */
